...
using VID_Issuance.Services;
using Microsoft.AspNetCore.Authorization;
using System.Security.Cryptography;

namespace VID_Issuance.Controllers
{
    ...
    public class IssuerController : Controller
    {
        ...
        private IssuanceRequest SetClaims(IssuanceRequest request)
        {
            ...
            string Name = HttpContext.User.Claims.FirstOrDefault(c => c.Type == ClaimTypes.GivenName)?.Value;
            ...
            request.claims.Add("JobTitle", JobTitle);
            request.claims.Add("given_name", Name);
            request.claims.Add("family_name", Family_Name);
            request.claims.Add("email", Email);
            request.claims.Add("Mobile", Mobile);
            request.claims.Add("Country", Country);
            request.claims.Add("Department", Department);
